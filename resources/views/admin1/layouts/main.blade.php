...
<head>
	...
	<title>Quản trị - Store | @yield('title')</title>
	<!-- css -->
...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<form role="search">
               		...
               		<ul class="nav menu">
			<li class="active"><a href="{{ route('admin.products.index') }}"><svg class="glyph stroked dashboard-dial"><use xlink:href="#stroked-dashboard-dial"></use></svg> Tổng quan</a></li>
