				...
				<div class="row row-pb-lg">
					<div class="col-md-4 text-center">
						<div class="product-entry">
							<div class="product-img" style="background-image: url({{asset('assets/client')}}/images/quan-kaki-do-man-qk162-8273.jpg);">
					...
					<div class="col-md-4 text-center">
						<div class="product-entry">
							<div class="product-img" style="background-image: url({{asset('assets/client')}}/images/quan-kaki-nauqk178-10366.jpg);">
					...
					<div class="col-md-4 text-center">
						<div class="product-entry">
							<div class="product-img" style="background-image: url({{asset('assets/client')}}/images/quan-kaki-xam-chuot-dam-qk171-9770.jpg);">
